...
![nav-sim-loop.gif](D:\work\personal\nav-sim\doc\nav-sim-loop.gif)
...
![nav-sim-waypoint.gif](C:\Users\majia\Desktop\nav-sim-waypoint.gif)

> For more details about navigation algorithm, please refer to the [DeepPlankter]([GitHub - majianjia/DeepPlankter](https://github.com/majianjia/DeepPlankter)) project. 
